...
CREATE TABLE `accountmanagement` (
  ...
  `account_owner` varchar(15) DEFAULT NULL,
  `account_species` varchar(5) DEFAULT NULL,
  `bank_name` varchar(20) DEFAULT NULL,
  `account_code` int DEFAULT NULL,
  `first_date` date DEFAULT NULL,
  `publish_date` date DEFAULT NULL,
  `first_branch` varchar(5) DEFAULT NULL,
  `account_password` int DEFAULT NULL,
  `publish_branch` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`account_num`),
  CONSTRAINT `R_14` FOREIGN KEY (`account_num`) REFERENCES `customermanagement` (`account_num`)
